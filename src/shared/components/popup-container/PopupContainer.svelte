<script lang="ts">
    ...
    let globalPopupContainer =
      (document.querySelector('#animator-popup-container') as HTMLDivElement) ?? createPopupContainer();
    ...
    function positionPopupToAnchor() {
      ...
      popupElement.style.top = `${getTopPosition(anchorRect.top, popupRect.height, containerRect.height, anchorRect.height) + positionOffset.y}px`;
